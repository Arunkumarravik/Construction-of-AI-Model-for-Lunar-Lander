...
Original file is located at
    https://colab.research.google.com/drive/1V5Y7RJAxuBE02glbglRjhw9-LfFqpHDM
...
"""Implemening the Deep Q-Neural class"""
  ...
  def step(self, state, action, reward, next_state, done):
    ...
    if self.t_step==0:
      if len(self.memory.memory) > minibatch_size:
        experiences = self.memory.sample(50)
